...
RSpec.describe Company, type: :model do
  ...
  describe '#operations_numbers' do
    it 'returns number of operations of the company' do
      expect(company.operations_number).to eq 3
    end
  end

  describe '#average_amount' do
    it 'returns average amount of operations of the company' do
      expect(company.average_amount).to eq 100000
    end
  end

  describe '#accepted_operations_num' do
    it 'returns number accepted operations of the company' do
      expect(company.accepted_operations_num).to eq 3
    end
  end

  describe '#highest_month_operations' do
    it 'returns the highest month operation of the company during a current month ' do
